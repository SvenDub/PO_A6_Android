...
/**
 * Deze class gebruikt een achtergrond thread om de tafels op te halen.
 * 
 * @author Sven Dubbeld <sven.dubbeld1@gmail.com>
 * @see AsyncTask
 */
public class TafelStatusTask extends AsyncTask<List<NameValuePair>, Void, JSONObject> {
     ...
     */
    private static final String TAG = "TafelStatusTask";
    ...
    /**
     * Start een nieuwe <code>TafelStatusTask</code> om de tafels op te halen.
     * 
     * @param context {@link Context} De Activity die de Task start.
     */
    public TafelStatusTask(Context context) {
    ...
    protected void onPostExecute(JSONObject result) {
        ...
        if (error == null) {
            ...
            try {
                ...
                if (Integer.parseInt(res) == 1) {
                    ...
                    // Haal 'tafels' object op
                    JSONObject json_tafels = result.getJSONObject("tafels");
                    Iterator<?> tafels = json_tafels.keys();
                    
                    // Voeg tafels toe aan database
                    mDb.leegTafels();
                    while (tafels.hasNext()) {
                        String id = tafels.next().toString();
                        String status = json_tafels.getString(id);
                    ...
                    switch (Integer.parseInt(res)) {
                        case 1:
                            ...
                            Toast toast1 = Toast.makeText(mContext, R.string.error_tag, Toast.LENGTH_SHORT);
                            toast1.show();
        ...
        new ProductenTask(mContext).execute(params);
    }

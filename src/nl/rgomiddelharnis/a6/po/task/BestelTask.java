...
/**
 * Deze class gebruikt een achtergrond thread om een bestelling toe te voegen.
 * 
 * @author Sven Dubbeld <sven.dubbeld1@gmail.com>
 * @see AsyncTask
 */
public class BestelTask extends AsyncTask<List<NameValuePair>, Void, JSONObject> {
     ...
     */
    private static final String TAG = "BestelTask";
    ...
    /**
     * Start een nieuwe <code>BetselTask</code> om een bestelling toe te voegen.
     * 
     * @param context {@link Context} De Activity die de Task start.
     */
    public BestelTask(Context context) {
        ...
        if (error == null) {
            ...
            try {
                ...
                if (Integer.parseInt(res) == 1) {
                    ...
                    new BestellingenTask(mContext).execute(params);

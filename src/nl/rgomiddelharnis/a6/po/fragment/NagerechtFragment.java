...
/**
 * Fragment met een lijst van alle nagerechten om toe te voegen aan een
 * bestelling.
 * 
 * @author Sven Dubbeld <sven.dubbeld1@gmail.com>
 */
public class NagerechtFragment extends SherlockListFragment {
    ...
    private static final String TAG = "NagerechtFragment";

    DatabaseHandler mDb;

    public NagerechtFragment() {
        // TODO Auto-generated constructor stub
    }

    /**
     * Laat alle nagerechten zien.
     */
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<Map<String, Object>> data = mDb.getProducten(4);
